...
setwd("H:/Behaviour(onedrive)/OFT/DLC_Analyzer")

#path of DLCAnalyzer_Functions_final.R file -- copied from https://github.com/ETHZ-INS/DLCAnalyzer
source("H:/Behaviour(onedrive)/OFT/DLC_Analyzer/DLCAnalyzer-master/R/DLCAnalyzer_Functions_final.R")
...
Tracking <- ReadDLCDataFromCSV(file = "H:/Behaviour(onedrive)/OFT/Videos_processed/Ai32_optostimulation/2021-08-13 12-00-09/cam_port1DLC_resnet50_open-fieldAug20shuffle1_133500.csv", fps = 10)
names(Tracking$data)
...
#cut ending frames (max 9000 frames)
Tracking <- CutTrackingData(Tracking, end = 1381)
PlotPointData(Tracking, points = "head")
...
PlotZoneSelection(Tracking, point = "head", zones = "center")
...
write.csv(ReportCenter,"H:/Behaviour(onedrive)/OFT/Videos_processed/Ai32_optostimulation/2021-08-13 12-00-09/report_center_2021-08-13 12-00-09.csv", row.names = TRUE)
...
##create .csv from report periphery --- choose output folder
write.csv(ReportPeriphery,"H:/Behaviour(onedrive)/OFT/Videos_processed/Ai32_optostimulation/2021-08-13 12-00-09/report_periphery_2021-08-13 12-00-09.csv", row.names = TRUE)

#PlotZoneVisits(Tracking, point = "head")
png(file="H:/Behaviour(onedrive)/OFT/Videos_processed/Ai32_optostimulation/2021-08-13 12-00-09/Rplot_density_path_2021-08-13 12-00-09.png", width=827, height=577)
plots <- PlotDensityPaths(Tracking,points = c("head"))
plots$head
dev.off()
png(file="H:/Behaviour(onedrive)/OFT/Videos_processed/Ai32_optostimulation/2021-08-13 12-00-09/Rplot_density_path_zones_2021-08-13 12-00-09.png", width=827, height=577)
plots <- AddZonesToPlots(plots, Tracking$zones)
plots$head
dev.off()
